...
public class DAOUsuario {
    ...
    public int insertarUsuarios(TOUsuario tousuario) {
        String[] valores = {tousuario.getNombreUsuario(), tousuario.getApellidoUsuario(), tousuario.getCedulaUsuario(), tousuario.getGeneroUsuario(), tousuario.getRolUsuario(), tousuario.getContrasenaUsuario(), tousuario.getEmailusuario(), tousuario.getCelularUsuario(), tousuario.getDireccionUsuario(), String.valueOf(tousuario.getCodigoUsuario())};
    ...
    public boolean actualizarUsuario(TOUsuario tousuario) {
        String[] valores = {tousuario.getNombreUsuario(), tousuario.getApellidoUsuario(), tousuario.getCedulaUsuario(), tousuario.getGeneroUsuario(), tousuario.getRolUsuario(), tousuario.getContrasenaUsuario(), tousuario.getEmailusuario(), tousuario.getCelularUsuario(), tousuario.getDireccionUsuario(), /*tousuario.getCodigoUsuario()*/};
    ...
    public TOUsuario verificarUsuario(String nombreUsuario, String contrasenaUsuario) {
        String condiciones = " nombreUsuario = '" + nombreUsuario + "' AND contrasenaUsuario = '" + contrasenaUsuario + "'";
        ...
        try {
            ...
            while (rs.next()) {
                ...
                tousuario.setNombreUsuario(rs.getString("nombreUsuario"));  
                tousuario.setApellidoUsuario(rs.getString("apellidoUsuario"));
                tousuario.setCedulaUsuario(rs.getString("cedulaUsuario"));
                tousuario.setGeneroUsuario(rs.getString("generoUsuario"));
                tousuario.setRolUsuario(rs.getString("rolUsuario"));
                tousuario.setContrasenaUsuario(rs.getString("contrasenaUsuario"));
