...
public class DAORegistro {
    ...
    public ArrayList<TORegistro> consultarRegistro() {// el consultarUsuario es el nombre de la funcionpara consultar usuarios
        ...
        try {
            ...
            while (rs.next()) {
                ...
                toregistro.setFechaEntrada(rs.getString("fechaEntrada"));//apellidoUsuario
                toregistro.setFechaSalida(rs.getString("fechaSalida"));
                toregistro.setFechaFactura(rs.getString("fechaFactura"));
    ...
    public int insertarRegistros(TORegistro toregistro ) {
        if (toregistro.getFechaEntrada() == null);{
            toregistro.setFechaEntrada("1990-01-01");
        }
        
        if (toregistro.getFechaSalida() == null);{
            toregistro.setFechaSalida("1990-01-01");
        }
        
        if (toregistro.getFechaFactura()== null);{
            toregistro.setFechaFactura("1990-01-01");
        }
